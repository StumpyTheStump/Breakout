...
BreakoutTutorialApp::BreakoutTutorialApp() {
...
bool BreakoutTutorialApp::startup() {
...
void BreakoutTutorialApp::shutdown() {

	delete m_font;
	delete m_2dRenderer;
}

void BreakoutTutorialApp::update(float deltaTime) {
	...
	{
		glm::vec4(0.5, 0.095f, 0.095f, 1), glm::vec4(1, 0.73f, 0, 1),
		glm::vec4(0.37f, 0.51f, 0.71f, 1), glm::vec4(0.9f, 0.17f, 0.31f, 1),
		glm::vec4(0.004f, 0.84f, 0.345f, 1)
	};
